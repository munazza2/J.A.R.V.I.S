...
def Record_Option(option):
    ...
    VideoFile_name = f'.\\JARVIS\\Recorded\\Screen\\VideoFile-{time_stamp}.mp4'
    AudioFile_name = f'.\\JARVIS\\Recorded\\Audio\\AudioFile-{time_stamp}.wav'
    OutputFileName = f'.\\JARVIS\\Recorded\\SCREENRECORDED\\VideoFile-{time_stamp}.mp4'
    frames=[]

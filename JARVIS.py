...
class MainThread(QThread):
    ...
    def run_jarvis(self):
        ...
        while True:
            ...
            elif ('your age' in self.command) or ('are you there' in self.command) or ('tell me something' in self.command) or ('thank you' in self.command):
            ...
            elif ('open teams'in self.command) or ('open stream'in self.command) or ('open sharepoint'in self.command) or('open outlook'in self.command)or('open MCB portal'in self.command)or('open octave'in self.command):
            ...
            #Eg: Jarvis play music
                ...
                music_dir = 'C:/Users/Munazza/Videos/music' #change the song path directory if you have songs in other directory
    ...
    def Covid(self,s):
        try:
            ...
            Cured = ss["Cured"]
            Death = ss["Death"]
            print(f" the total cases in {s} are {Total}, the number of active cases are {Active}, and {Cured} people cured, and {Death} people are death")
            self.talk(f"the total cases in {s} are {Total}, the number of active cases are {Active}, and {Cured} people cured, and {Death} people are death")
            time.sleep(5)
            self.talk(" do you want any information of other states")
            I = self.take_Command()
            print(I)
            if ("check" in I):
                self.Covid(I)
            elif("no" in I):
                self.talk("Okay  stay home stay safe")
            else:
                self.talk("Okay  stay home stay safe")
        except:
            self.talk("some error occured, please try again")
            self.talk(" do you want any information of other states")
            I = self.take_Command()
            if("yes" in I):
                self.talk(", Which state covid status do u want to check")
    ...
    def AddContact(self):
        ...
        ContFile.write(f"{NumberFormat}/n")
        ContFile.close()
    ...
    def Fun(self,command):
        ...
        if 'your name' in command:
            ...
            self.talk("your name is Munazza")
        elif 'university name' in command:
            self.talk("you are studing in symbiosis convent high school") 
    ...
    def shedule(self):
        ...
        self.talk("today's shedule is")
        Week = {"monday" : "from 9:00 to 9:50 you have Cultural class, from 10:00 to 11:50 you have mechanics class, from 12:00 to 2:00 you have brake, and today you have sensors lab from 2:00",
        "tuesday" : "from 9:00 to 9:50 you have English class, from 10:00 to 10:50 you have break,from 11:00 to 12:50 you have ELectrical class, from 1:00 to 2:00 you have brake, and today you have biology lab from 2:00",
        "wednesday" : "today you have a full day of classes from 9:00 to 10:50 you have Data structures class, from 11:00 to 11:50 you have mechanics class, from 12:00 to 12:50 you have cultural class, from 1:00 to 2:00 you have brake, and today you have Data structures lab from 2:00",
        "thrusday" : "today you have a full day of classes from 9:00 to 10:50 you have Maths class, from 11:00 to 12:50 you have sensors class, from 1:00 to 2:00 you have brake, and today you have english lab from 2:00",
        "friday" : "today you have a full day of classes from 9:00 to 9:50 you have Biology class, from 10:00 to 10:50 you have data structures class, from 11:00 to 12:50 you have Elements of computing class, from 1:00 to 2:00 you have brake, and today you have Electronics lab from 2:00",
        "saturday" : "today you have a full day of classes from 9:00 to 11:50 you have maths lab, from 12:00 to 12:50 you have english class, from 1:00 to 2:00 you have brake, and today you have elements of computing lab from 2:00",
        "sunday":"today is holiday but we can't say anything when they will bomb with any assisgnments"}
        if day in Week.keys():
            self.talk(Week[day])
    ...
    def open_source(self,command):
        ...
        if 'github' in command:
            ...
            webbrowser.open('https://github.com/munazza2')
    ...
    def SendEmail(self,to,content):
        ...
        server.ehlo()
        server.starttls()
        server.login("kazitabrez4@gmail.com","@18062009")
...
class Main(QMainWindow):
    ...
    def startTask(self):
        ...
        self.ui.movie = QtGui.QMovie("./UI/ringJar.gif")
